...
function App() {
  ...
  const fetchItems = () => {
    fetch('https://bookstore-c4103-default-rtdb.europe-west1.firebasedatabase.app/books/.json')
  ...
  const deleteBook = (id) => {
    fetch(`https://bookstore-c4103-default-rtdb.europe-west1.firebasedatabase.app/books/${id}.json`,
        {
          method: 'DELETE',
        })
        .then(response => fetchItems())
  ...
  return (
      <div className="App">
        ...
        <div className="ag-theme-material" style={ { height: 500, width: 1200, margin: 'auto' } }>
